...
Welcome to the Beginners Guide to IoT and Hardware Hacking official git repository. Here you'll find useful resources for the course, scripts, and product links for the tools used in the course. 
...
These are located in the resources directory.
